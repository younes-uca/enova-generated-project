...
public class HistProtocoleInclusionSpecification implements Specification<HistProtocoleInclusion> {

    private final HistProtocoleInclusionCriteria criteria;
    private boolean distinct;

    public HistProtocoleInclusionSpecification(HistProtocoleInclusionCriteria criteria) {

        this.criteria = criteria;
    }

    public HistProtocoleInclusionSpecification(HistProtocoleInclusionCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistProtocoleInclusion> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
