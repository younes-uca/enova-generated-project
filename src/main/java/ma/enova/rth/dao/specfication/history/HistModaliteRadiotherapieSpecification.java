...
public class HistModaliteRadiotherapieSpecification implements Specification<HistModaliteRadiotherapie> {

    private final HistModaliteRadiotherapieCriteria criteria;
    private boolean distinct;

    public HistModaliteRadiotherapieSpecification(HistModaliteRadiotherapieCriteria criteria) {

        this.criteria = criteria;
    }

    public HistModaliteRadiotherapieSpecification(HistModaliteRadiotherapieCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistModaliteRadiotherapie> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
