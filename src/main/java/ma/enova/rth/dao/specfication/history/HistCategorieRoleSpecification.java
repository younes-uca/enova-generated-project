...
public class HistCategorieRoleSpecification implements Specification<HistCategorieRole> {

    private final HistCategorieRoleCriteria criteria;
    private boolean distinct;

    public HistCategorieRoleSpecification(HistCategorieRoleCriteria criteria) {

        this.criteria = criteria;
    }

    public HistCategorieRoleSpecification(HistCategorieRoleCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistCategorieRole> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
