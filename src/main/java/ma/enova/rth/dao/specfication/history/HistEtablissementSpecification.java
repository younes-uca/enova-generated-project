...
import ma.enova.rth.bean.historique.HistEtablissement;
...
public class HistEtablissementSpecification implements Specification<HistEtablissement> {

    private final HistEtablissementCriteria criteria;
    private boolean distinct;

    public HistEtablissementSpecification(HistEtablissementCriteria criteria) {

        this.criteria = criteria;
    }

    public HistEtablissementSpecification(HistEtablissementCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistEtablissement> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
