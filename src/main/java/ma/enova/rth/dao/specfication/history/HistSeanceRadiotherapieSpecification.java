...
public class HistSeanceRadiotherapieSpecification implements Specification<HistSeanceRadiotherapie> {

    private final HistSeanceRadiotherapieCriteria criteria;
    private boolean distinct;

    public HistSeanceRadiotherapieSpecification(HistSeanceRadiotherapieCriteria criteria) {

        this.criteria = criteria;
    }

    public HistSeanceRadiotherapieSpecification(HistSeanceRadiotherapieCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistSeanceRadiotherapie> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
