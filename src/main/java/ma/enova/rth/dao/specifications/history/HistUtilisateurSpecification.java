...
public class HistUtilisateurSpecification implements Specification<HistUtilisateur> {

    private final HistUtilisateurCriteria criteria;
    private boolean distinct;

    public HistUtilisateurSpecification(HistUtilisateurCriteria criteria) {

        this.criteria = criteria;
    }

    public HistUtilisateurSpecification(HistUtilisateurCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistUtilisateur> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
