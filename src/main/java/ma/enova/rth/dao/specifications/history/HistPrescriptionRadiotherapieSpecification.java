...
public class HistPrescriptionRadiotherapieSpecification implements Specification<HistPrescriptionRadiotherapie> {

    private final HistPrescriptionRadiotherapieCriteria criteria;
    ...
    @Override
    public Predicate toPredicate(Root<HistPrescriptionRadiotherapie> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
