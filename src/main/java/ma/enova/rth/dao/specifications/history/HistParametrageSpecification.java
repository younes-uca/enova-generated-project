...
public class HistParametrageSpecification implements Specification<HistParametrage> {

    private final HistParametrageCriteria criteria;
    private boolean distinct;

    public HistParametrageSpecification(HistParametrageCriteria criteria) {

        this.criteria = criteria;
    }

    public HistParametrageSpecification(HistParametrageCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistParametrage> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
