...
public class HistPersonnelSpecification implements Specification<HistPersonnel> {

    private final HistPersonnelCriteria criteria;
    private boolean distinct;

    public HistPersonnelSpecification(HistPersonnelCriteria criteria) {

        this.criteria = criteria;
    }

    public HistPersonnelSpecification(HistPersonnelCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistPersonnel> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
