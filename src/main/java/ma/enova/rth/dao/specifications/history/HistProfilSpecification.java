...
public class HistProfilSpecification implements Specification<HistProfil> {

    private final HistProfilCriteria criteria;
    private boolean distinct;

    public HistProfilSpecification(HistProfilCriteria criteria) {

        this.criteria = criteria;
    }

    public HistProfilSpecification(HistProfilCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistProfil> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
