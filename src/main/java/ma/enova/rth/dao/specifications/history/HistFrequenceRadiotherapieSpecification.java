...
public class HistFrequenceRadiotherapieSpecification implements Specification<HistFrequenceRadiotherapie> {

    private final HistFrequenceRadiotherapieCriteria criteria;
    private boolean distinct;

    public HistFrequenceRadiotherapieSpecification(HistFrequenceRadiotherapieCriteria criteria) {

        this.criteria = criteria;
    }

    public HistFrequenceRadiotherapieSpecification(HistFrequenceRadiotherapieCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistFrequenceRadiotherapie> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
