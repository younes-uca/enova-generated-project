...
public class HistOrganeSpecification implements Specification<HistOrgane> {

    private final HistOrganeCriteria criteria;
    private boolean distinct;

    public HistOrganeSpecification(HistOrganeCriteria criteria) {

        this.criteria = criteria;
    }

    public HistOrganeSpecification(HistOrganeCriteria criteria, boolean distinct) {
    ...
    @Override
    public Predicate toPredicate(Root<HistOrgane> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
