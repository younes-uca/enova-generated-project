package ma.enova.rth.zynerator.audit;
...
public class EntityListener implements Serializable {
    ...
    public String getCurrentUser() {
        if (SecurityContextHolder.getContext().getAuthentication() != null) {
            ...
            } else if (currentUser != null && currentUser instanceof UtilisateurDetailsImpl) {
                return ((UtilisateurDetailsImpl) currentUser).getNomComplet();
            } else return null;
        }
