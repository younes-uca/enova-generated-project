package ma.enova.rth.zynerator.util;

import ma.enova.rth.zynerator.audit.AuditEntity;
import ma.enova.rth.zynerator.audit.Log;
import ma.enova.rth.zynerator.bean.BusinessObject;
import ma.enova.rth.zynerator.bean.EnumBean;
