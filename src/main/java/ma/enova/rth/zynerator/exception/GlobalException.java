package ma.enova.rth.zynerator.exception;
...
public class GlobalException extends Exception implements Serializable {
    ...
    public GlobalException(Exception e, MessageSource messageSource, String requestURI) {
        ...
        if (e instanceof ClientAbortException) {
            ...
            System.out.println(Utils.DEFAULT_APP_NAME + " : ClientAbortException : " + requestURI + " : user : " + currentUser.getNomComplet());
            ...
            if (ex != null) {
                ...
                status = HttpStatus.INTERNAL_SERVER_ERROR;
                UtilisateurDetailsImpl currentUser = (UtilisateurDetailsImpl) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
                System.out.println(Utils.DEFAULT_APP_NAME + " : " + requestURI + " : " + "user : " + currentUser.getNomComplet());
                e.printStackTrace();
            }
        }
